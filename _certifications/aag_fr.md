...
.translation-container:hover .translation-hover {
  display: block;
}
</style>
    ...
    <div class="col-sm-8 mt-3 mt-md-0">
        <div class="translation-container">
             ...
             <div class="translation-hover">
                ...
                Bien que des recherches récentes aient examiné la diffusion des véhicules électriques sous l'angle des infrastructures et de la politique environnementale, les dimensions spatiales et sociales de cette transformation en France restent inégalement explorées. Ma recherche vise donc à produire une géographie sociale de l'électrification du parc de véhicules électriques en France.<br><br>
                Mon étude examine où les véhicules électriques sont les plus répandus en France, quels facteurs démographiques et territoriaux influencent leur adoption, et comment identifier les zones à fort potentiel d'électrification des véhicules, en intégrant ces données dans un cadre d'optimisation spatiale et d'analyse territoriale.<br><br>
                Les données utilisées sont principalement open source et agrégées à l'échelle IRIS (unités de recensement de petite taille équivalentes approximativement aux secteurs de recensement), avec des variables telles que le niveau d'éducation, le statut socio-professionnel, le revenu des ménages, les prix des carburants, le comportement électoral et la distance moyenne de trajet.
             </div>
        </div>
    </div>
</div>
